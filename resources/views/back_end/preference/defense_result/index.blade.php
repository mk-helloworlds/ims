...
<div class="col-md-12 offset-sm">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title float-left">ALL STUDENT EVALUATION - RESULTS</h4>
            
            <a href="{{ route('export.defense.results') }}" class="btn btn-sm btn-success float-right"><i class="fa fa-arrow-down" aria-hidden="true"></i><p></p>Export to Excel</a>
        </div>
            ...
            <table class="table table-hover mt-3">
                ...
                <tbody>
                    @foreach ($defenseEnrollments as $defenseEnrollment)
                        <tr>
                            <td><input type="checkbox" name="selected_rows[]" value="{{ $defenseEnrollment->id }}"></td>
