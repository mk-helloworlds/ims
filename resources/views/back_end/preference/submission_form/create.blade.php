...
<div class="col-md-12 offset-sm">
    <div class="card">
                ...
                <form id="user-form" action="{{ route('submission_form.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label for="student_request_id">Select Student (with accepted request)</label>
                                <select name="student_request_id" class="form-control" required>
                                    <option value="">SELECT STUDENT</option>
                                    @foreach ($studentRequests as $studentRequest)
                                        <option value="{{ $studentRequest->id }}">
                                            Student Name: {{ $studentRequest->student->name }} | {{ $studentRequest->internship->internship_title }} (Advisor: {{ $studentRequest->advisor->name }})
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="col-md-12">
                        <a href="{{route('submission_form.index')}}" class="btn btn-secondary" data-dismiss="modal">Cancel</a>
