        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{route('submission_form.create')}}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-flex">
                                            <!-- Edit button -->
                                            <a href="{{ route('submission_form.edit', $row->id) }}" class="btn btn-sm btn-primary mr-1">Edit</a>

                                            <!-- Delete button -->
                                            <form action="{{ route('submission_form.destroy', $row->id) }}" method="POST" class="form-inline">
                                                @csrf
                                                @method('DELETE')
