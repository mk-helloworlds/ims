                    ...
                    <tbody>
                        @foreach ($results as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- EVALUATION BUTTON PAGE -> SHOW STUDENT SPECIFIC PAGE -->
                                    <!-- The ROW->ID referencing the defense_enrollment tables -->
                                    <a href="{{ route('jury_evaluation.show', $row->id) }}" class="btn btn-sm btn-warning">Evaluate Student</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
