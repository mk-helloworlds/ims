			...
			<footer class="footer">
				<div class="container-fluid">
					<nav class="pull-left">
						<ul class="nav">
							<li class="nav-item">
								<a class="nav-link" href="http://www.edutech.cadt.edu.kh">
									EduTech
								</a>
							</li>
							<li class="nav-item">
					...
					<div class="copyright ml-auto">
						2018, made with <i class="fa fa-heart heart text-danger"></i> by <a href="http://www.edutech.cadt.edu.kh">EduTech</a>
					</div>				
				</div>
			</footer>
		</div>
